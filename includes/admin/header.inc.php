...
<head>
	...
	<link rel="stylesheet" href="./themes/dark/css/4me.css" type="text/css">
	<script src="./themes/dark/js/jquery-2.1.4.min.js"></script>
	<script src="./themes/dark/js/4menu.js"></script>
	<script src="./themes/dark/js/scripts.js"></script>
	<script>
(function($) {
