...
function updateImage() {
	$.get ( "thumb", { thumb: $("#deleteVidSelect").val() }).done(function (data) { $("#dp").attr("src", data); });
}
function Confirmation() {
	return confirm("WARNING: Adding/Deleting can cause issues with your data integrity, are you sure you want to continue?");
}
...
function changeTab(n) {
	var c = [ document.getElementById('admin'), document.getElementById('database'), document.getElementById('category'), document.getElementById('video'),document.getElementById('removecat'),document.getElementById('removevid'), document.getElementById('account') ];
